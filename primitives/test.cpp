...
int main() {
    ...
    cout << "Rng (2-5): " << eopi::primitives::rng_coin(2, 5) << " "
     ...
     eopi::primitives::Rectangle first{eopi::primitives::Point{0,0},eopi::primitives::Point{3,2}};
     eopi::primitives::Rectangle second{eopi::primitives::Point{1,1},eopi::primitives::Point{2,4}};

     cout << first << " and " << second << " intersect in: " << first.intersect(second) << endl;
    return 0;
}
