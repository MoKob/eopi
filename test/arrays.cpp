...
#include "arrays/bigint.hpp"
#include "arrays/primes.hpp"
#include "arrays/randoms.hpp"
#include "arrays/sudoku.hpp"

using namespace std;

template <typename int_type> void print(vector<int_type> const &vec) {
  cout << "[vector]";
  for (auto e : vec)
    cout << " " << e;
  cout << endl;
...
int main() {
  ...
  cout << "Expecting: 0 -- " << eopi::arrays::max_product_all_but_one(zero)
       << " " << eopi::arrays::max_product_all_but_one(negatives_zero) << endl;
