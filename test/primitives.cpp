#include "primitives/bit_operations.hpp"
#include "primitives/conversion.hpp"
#include "primitives/doors.hpp"
...
int main() {
  ...
  cout << "Divisin: " << 127 * 123456 << " by 127 "
       << eopi::primitives::divide_without_operators(127 * 123456, 127) << endl;
